...
FT_BEGIN_HEADER
   ...
   *   a vector outline, or even resources in other formats.  These objects are
   ...
   *
   * @description:
   *   Handle to an object used to model generic glyph resources.  It is a
   ...
   *
   * @description:
   *   A structure used for bitmap glyph resources.  This really is a
   ...
   *
   * @description:
   *   A structure used for outline (vectorial) glyph resources.  This really is
