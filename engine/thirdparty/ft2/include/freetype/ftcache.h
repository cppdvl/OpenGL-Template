...
FT_BEGIN_HEADER
   ...
   *   resources while limiting their maximum memory usage.
   *
   ...
   *
   * @description:
   *   A structure used to model the type of resources in a glyph cache.
   *
   * @fields:
   *   face_id ::
   *     The face ID.
...
#define FTC_IMAGE_TYPE_COMPARE( d1, d2 )      \
   ...
   *   many distinct glyph resources while not exceeding a certain memory
   *   threshold.
   */
