...
#define ft_open_params    FT_OPEN_PARAMS
   ...
   *     font format.
   *
   *     [Since 2.5] Load embedded color bitmap resources.  The resulting color
   ...
   *     using the same bitmap format as embedded color bitmap resources.  This
...
#define FT_LOAD_TARGET_MODE( x )  ( (FT_Render_Mode)( ( (x) >> 16 ) & 15 ) )
   ...
   *
   * @description:
   *   Set the transformation that is applied to glyph resources when they are
