...
FT_BEGIN_HEADER
   ...
   *     resources.  Each pixel is stored in one byte.  Note that the number of
   ...
   *
   *   FT_PIXEL_MODE_LCD ::
   *     An 8-bit bitmap, representing RGB or BGR decimated glyph resources used
...
#define FT_IMAGE_TAG( value, _x1, _x2, _x3, _x4 )  \
   ...
   *     The glyph image is a composite of several other resources.  This format
